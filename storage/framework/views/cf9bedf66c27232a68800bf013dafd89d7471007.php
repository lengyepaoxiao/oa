...
<div class="x-body">
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加','<?php echo e(url("admin/add")); ?>',1000,800)"><i class="layui-icon"></i>添加</button>
...
<script>
    layui.use(['laydate','layer','form','jquery'],function(){
        ...
        //自动加载
        var url = "<?php echo e(url("admin/get_lists")); ?>";
...
<script id="tpl-lists" type="text/html">
    ...
    <tr>
        ...
        <td>
            ...
            <a onclick="x_admin_show('设置','<?php echo e(url('admin/edit/@{@ item.id @}@')); ?>')" href="javascript:;"  title="设置">
...
<script>
    ...
    function deletes(obj,id,isdel){
        var url = '<?php echo e(url("admin/deletes")); ?>';
        var data = {'_token': '<?php echo e(csrf_token()); ?>',
            'id': id,
            'isdel': isdel};
