...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/js/layui/layui.js')); ?>" charset="utf-8"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/xadmin.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/apidata.js')); ?>"></script>
    <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
    <!--[if lt IE 9]>
