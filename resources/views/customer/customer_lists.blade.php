...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加','{{url("customer/add")}}',1000,800)"><i class="layui-icon"></i>添加</button>
...
<script>
    layui.use(['laydate','layer','form','jquery'],function(){
        ...
        //自动加载
        var url = "{{url("customer/get_lists")}}";
...
<script id="tpl-lists" type="text/html">
    ...
    <tr>
        ...
        <td>
            <a onclick="x_admin_show('编辑','{{url('customer/edit/@{@ item.id @}@')}}')" href="javascript:;"  title="设置">
                <i class="layui-icon">&nbsp;&#xe642;</i>
            </a>
