    ...
    <form class="layui-form" id="admin-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="customer_id" name="customer_id" lay-filter="" lay-verify="required" onchange="getAddress();">
        ...
        <div class="layui-form-item">
            <label for="type" class="layui-form-label">
                <span class="x-red">*</span>派单类型
            </label>
            <div class="layui-input-inline">
                <select id="type" name="type" lay-filter="" lay-verify="required">
                    @foreach($type as $k=>$v)
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:700px;">
                <input  type="text" id="address" name="address" required="" lay-verify="required"
                        autocomplete="off" class="layui-input" oninput="realTimeFind($(this).val());" onblur="searchByStationName();">
                <div id="realTimeBox" style="color: #C9C9C9"></div>
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    function realTimeFind(val){
        var url = "{{url('task/find')}}";
        let params = {
            'address': val
        };
        params['_token'] = "{{csrf_token()}}";
        ...
        $.post(url,params,function(ret){
            ...
            if(ret.status == 1){
                ...
                for(let i = 0; i < data.length; i++){
                    html += '<li onclick="changeAddress(\'' + data[i]['address'] + '\');"><a href=\'#\'>' + data[i]['address'] + '</a></li>';
                }
                html += '</ul>';
                $('#realTimeBox').append(html);
            }else{
                $('#realTimeBox').empty();
            }
        },'json');
